...
3. **興味タグを設定**: 趣味や興味が同じBuddiesを探しやすくなります
4. **自己紹介文を記入**: あなたの人柄が伝わりやすくなります
5. **SNSリンクを設定**: フォローしやすくなります。無言フォローOKか、一言欲しいかを設定することもできます。

---

## サポート

不具合や機能のリクエストがある場合は、[お問い合わせフォーム](https://buddies46.stars.ne.jp/satellite/buddies/form/)
からご連絡ください。
